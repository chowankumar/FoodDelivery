...
const Header = () => {
  return (
    ...
    <div className="header-contents  absolute flex flex-col items-start gap-[1.5vw] max-w-[50%] bottom-[10%] left-[6vw]">
        <h2 className='font-[500] text-white text-[75px]'>Order your favourite food here</h2>
        <p className='text-white text-[18px]'>Choose from a diverse menu featuring a delectable array of dishes crafted with the satisfy your dinning experience, one delicious meal at a time.</p>
